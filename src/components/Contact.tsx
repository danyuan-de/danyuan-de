...
export default function Contact() {
    ...
    return (
        <section id="contact" className="min-h-screen flex flex-col justify-center items-center text-center px-6 py-24 bg-gradient-to-b from-[#0f172a] via-[#020617] to-[#020617] text-white">
            <motion.h2
